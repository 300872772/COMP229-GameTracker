...
<div class="containerDecorationMatch" >
    ...
    <div class="row">        
        ...
        <div class="col-sm-4"><h3 id="matchDate" runat ="server">Today</h3></div>
        <div class="col-sm-4"> <h3 id="tournament" runat ="server"></h3></div>
        <div class="col-sm-4"> <h3 id="matchWeek" runat ="server"> </h3></div>
        </div>
     <br>
    ...
    <ItemStyle HorizontalAlign="Center" /> 
           ...
           <asp:BoundField DataField = 'TeamName2' HeaderText = 'Team 2' Visible = 'true' SortExpression = 'Team2'/>
            <asp:ImageField DataImageUrlField="Flag2"><ControlStyle CssClass="BotonDeImagen"/></asp:ImageField>
